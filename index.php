...
$select_edu_result = mysqli_query($conn,$select_edu);

//service

$select_service = "SELECT * FROM services WHERE status=1";
$select_service_result = mysqli_query($conn, $select_service);

//works

$works_count = "SELECT COUNT(*) as total_works_active FROM works WHERE status=1";
$works_count_result = mysqli_query($conn, $works_count);
$select_works_assoc = mysqli_fetch_assoc($works_count_result);

// fact area

$fact_select = "SELECT * FROM facts";
$fact_select_result = mysqli_query($conn,$fact_select);
...
$select_brand_img_result = mysqli_query($conn,$select_brand_img);


//contact

$select_contact = "SELECT * FROM contacts WHERE status=1";
$select_contact_result = mysqli_query($conn,$select_contact);
                        ...
                        <div class="col-xl-12">
                            <div class="main-menu">
                                <nav class="navbar navbar-expand-lg">
                                    ...
                                    <a href="index.html" class="navbar-brand s-logo-none"><img src="img/logo/logo.png" alt="Logo"></a>
        ...
        <main>
            ...
            <section id="about" class="about-area primary-bg pt-120 pb-120">
                <div class="container">
                    <div class="row align-items-center">
                        <div class="col-lg-6">
                            <div class="about-img">
                                <img width="550" src="/New folder/tiger/uploads/about/<?=$select_result_assoc['image']?>" title="me-01" alt="me-01">
                            </div>
                        </div>
            ...
            <section id="portfolio" class="portfolio-area primary-bg pt-120 pb-90">
                <div class="container">
                    ...
                    <div class="row">
                    <?php if ($select_works_assoc['total_works_active'] >= 3 && $select_works_assoc['total_works_active'] < 6) { ?>
                            <?php
                                $select_works = "SELECT * FROM works WHERE status=1 Limit 3";
                                $select_works_result = mysqli_query($conn,$select_works);
                                foreach($select_works_result as $select_result) { ?>
                                <div class="col-lg-4 col-md-6 pitem">
                                    <div class="speaker-box">
                                        <div class="speaker-thumb">
                                            <img src="uploads/work/<?=$select_result['project_image']?>" alt="img">
                                        </div>
                                        <div class="speaker-overlay">
                                            <span><?=$select_result['category']?></span>
                                            <h4><a href="portfolio-single.html"><?=$select_result['project_name']?></a></h4>
                                            <a href="work_details.php?id=<?=$select_result['id']?>" class="arrow-btn">More information <span></span></a>
                                        </div>
                                    </div>
                                </div> 
                             <?php } ?>
                             <?php } else {
                                  $select_works = "SELECT * FROM works WHERE status=1 limit 6";
                                  $select_works_result = mysqli_query($conn, $select_works);
                                 foreach ($select_works_result as $select_result) {
                    ?>
                        <div class="col-lg-4 col-md-6 pitem">
                        ...
                        <?php foreach($select_brand_img_result as $brand_imge) : ?>
                            <div class="col-xl-2">
                                <div class="single-brand">
                                    <img src="/New folder/tiger/uploads/brand/<?=$brand_imge['brand_img']; ?>" alt="img">
                                </div>
                            </div>
                        <?php endforeach; ?>
                    </div>
                    ...
                    <div class="row align-items-center">
                        <div class="col-12">
                            <div class="copyright-text text-center">
                                <p>Copyright© <span>RIAD</span> | All Rights Reserved</p>
                            </div>
                        </div>
                    </div>
                </div>
